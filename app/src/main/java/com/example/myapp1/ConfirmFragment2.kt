                                    ...
                                    db.collection("users").document(client)
                                        ...
                                        .addOnSuccessListener {it2->
                                            if(it2.exists()) {
                                                ...
                                                listProduct.add(ItemBill2(idProduct,imageUrl[0],title,price,city,"Xác nhận",client,receiverMap["name"].toString(),receiverMap["numberPhoneX"].toString(),receiverMap["addressInfor"].toString()))
                                            }
